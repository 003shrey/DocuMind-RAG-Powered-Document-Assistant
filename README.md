...
## Demo
Check out the live deployed app: Chat With Documents on Streamlit
...
1. Clone the repository:
   ```bash
   git clone https://github.com/003shrey/DocuMind-RAG-Powered-Document-Assistant.git
   cd DocuMind-RAG-Powered-Document-Assistant
   ```
...
4. Configure environment variables:
   ...
   ```
   You can also enter these keys via the sidebar in the app.
...
- Delete the persisted directory by ensuring any existing directory is removed before initializing a new database.
- Alternatively, follow Chroma’s migration guide to update the schema.
...
## Contact
For any questions or feedback, please open an issue on the GitHub repository or contact the repository owner.
